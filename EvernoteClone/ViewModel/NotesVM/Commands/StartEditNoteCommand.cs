...
namespace EvernoteClone.ViewModel.Commands
{
    ...
    public class StartEditNoteCommand : ICommand
    {
        #region Properties
        ...
        #region Constructors
        public StartEditNoteCommand(NotesVM vm)
        {
            VM = vm;
        }
        #endregion
        ...
        public void Execute(object parameter)
        {
            ...
            {
                VM.StartNoteEditing(noteWithVisibility.Note, noteWithVisibility.Note.NotebookId);
            }
        }
        #endregion
    }
